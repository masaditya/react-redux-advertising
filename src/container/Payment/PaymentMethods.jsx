    ...
    return (
        <div className="container px-5">
            ...
            <div id="payment-table" className="row">
                <div className="col-sm-6 border" id="cc-methods-payment">
                    <div className="row">
                ...
                <div className="col-sm-6 border" id="atm-methods-payment">
                    <div className="row">
                        <div className="col-lg-2 py-2 my-auto text-center">
                ...
                <div className="col-sm-6 border" id="gopay-methods-payment">
                    <div className="row">
                        <div className="col-lg-2 py-2 my-auto text-center">
                ...
                <div className="col-sm-6 border" id="klikbca-methods-payment">
                    <div className="row">
                        <div className="col-lg-2 py-2 my-auto text-center">
                ...
                <div className="col-sm-6 border" id="klikpay-methods-payment">
                    <div className="row">
                        <div className="col-lg-2 py-2 my-auto text-center">
                ...
                <div className="col-sm-6 border" id="indomart-methods-payment">
                    <div className="row">
                        <div className="col-lg-2 py-2 my-auto text-center">
                ...
                <div className="col-sm-6 border" id="alfamart-methods-payment">
                    <div className="row">
                        <div className="col-lg-2 py-2 my-auto text-center">
